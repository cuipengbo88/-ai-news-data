...
格式化规则（使用 HTML span 对关键词着色，让报告更醒目易读）：
- 公司/产品名：<span style="color:#2563EB">名称</span>（蓝色）
- 关键数字/数据：<span style="color:#EA580C">数字</span>（橙色）
- 核心判断/警告：<span style="color:#DC2626">判断</span>（红色）
- 正面信号/机会：<span style="color:#16A34A">利好</span>（绿色）
- 技术概念/术语：<span style="color:#7C3AED">术语</span>（紫色）
注意：每条快讯至少着色一个公司名或数字；深度分析自然着色即可，不用过度。
